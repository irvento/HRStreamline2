    ...
    <div x-data="{ selectedTab: 'info' }" class="w-full mt-13">
        <div @keydown.right.prevent="$focus.wrap().next()" @keydown.left.prevent="$focus.wrap().previous()"
            ...
            <button @click="selectedTab = 'info'" :aria-selected="selectedTab === 'info'"
                ...
                aria-controls="tabpanelInfo">Personal Info</button>
        ...
        <div class="px-2 py-4 text-neutral-600 dark:text-neutral-300">
            <div x-show="selectedTab === 'info'" id="tabpanelInfo" role="tabpanel" aria-label="info"><b><a
                        href="#" class="underline">Personal Info</a></b> tab is selected</div>
            <div x-show="selectedTab === 'qualifications'" id="tabpanelQualifications" role="tabpanel" aria-label="qualifications"><b><a
                        href="#" class="underline">Qualifications</a></b> tab is selected</div>
            <div x-show="selectedTab === 'comments'" id="tabpanelComments" role="tabpanel" aria-label="comments"><b><a
                        href="#" class="underline">Comments</a></b> tab is selected</div>
