    ...
    <div class="mb-4 flex items-center space-x-4">
        <form method="GET" action="{{ route('rattendance') }}" class="flex space-x-2">
            ...
            <div class="flex items-end">
                <button type="submit"
                    class="px-4 py-2 bg-blue-500 text-white rounded-md shadow hover:bg-blue-600">Filter</button>
            </div>
        </form>
    </div>
<div class="mb-4 flex items-center space-x-4">
    ...
    <table class="w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        <thead class="bg-gray-200 dark:bg-gray-700">
            <tr>
                ...
                <th class="px-4 py-2 text-left text-sm font-medium text-gray-800 dark:text-gray-200">Employee</th>
