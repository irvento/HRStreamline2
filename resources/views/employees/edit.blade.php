            ...
            <form action="{{ route('employees.update', $employee->employee_id) }}" method="POST"
                ...
                <div class="mb-4">
                    <label for="employee_fname"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">First Name</label>
                    <input type="text" id="employee_fname" name="employee_fname"
                        value="{{ old('employee_fname', $employee->employee_fname) }}"
                ...
                <div class="mb-4">
                    <label for="employee_lname"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Last Name</label>
                    <input type="text" id="employee_lname" name="employee_lname"
                        value="{{ old('employee_lname', $employee->employee_lname) }}"
                        class="mt-1 block w-full px-4 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-700 focus:ring focus:ring-primary-200" />
                ...
                <div class="mb-4">
                    <label for="contact1"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Contact</label>
                    <input type="text" id="contact1" name="contact1"
                        value="{{ old('contact1', $employee->contact1) }}"
                        class="mt-1 block w-full px-4 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-700 focus:ring focus:ring-primary-200" />
                    @error('contact1')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-4">
                    <label for="address_line_1"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Address Line 1</label>
                ...
                <div class="mb-4">
                    <label for="address_line_2"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Address Line 2</label>
                ...
                <div class="mb-4">
                    <label for="postal_code" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Postal
                        Code</label>
                ...
                <div class="mb-4">
                    <label for="birthdate"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Birthdate</label>
                ...
                <div class="mb-4">
                    <label for="gender"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Gender</label>
                ...
                <div class="mb-4">
                    <label for="imagePath"
                        class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Image</label>
                    <input type="file" id="imagePath" name="imagePath"
                        class="mt-1 block w-full px-4 py-2 text-sm rounded-lg border border-gray-300 dark:border-gray-700 focus:ring focus:ring-primary-200" />
                    <p class="text-sm text-gray-500 dark:text-gray-400">Leave empty if you don't want to change the
                        image.</p>
                    @error('imagePath')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                ...
                <div class="mt-6">
                    <button type="submit"
                        class="px-6 py-2 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition">Update
                        Employee</button>
                </div>
            </form>
        </div>
