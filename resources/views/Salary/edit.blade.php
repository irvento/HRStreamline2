<x-app-layout>
    <div class="max-w-4xl mx-auto mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
        ...
        <form action="{{ route('salary.update', $salary->salary_id) }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                <label for="salary_grade" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Salary
                    Grade</label>
                <input type="text" name="salary_grade" id="salary_grade"
                    value="{{ old('salary_grade', $salary->salary_grade) }}"
            ...
            <div class="space-y-2">
                <label for="salary_amount" class="block text-sm font-medium text-gray-600 dark:text-gray-300">Salary
                    Amount</label>
            ...
            <div class="space-y-2">
                <label for="payment_frequency_id"
                    class="block text-sm font-medium text-gray-600 dark:text-gray-300">Payment Frequency</label>
