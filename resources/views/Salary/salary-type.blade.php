    ...
    <table
        ...
        <thead class="bg-gray-100 dark:bg-gray-700">
            <tr>
                ...
                <th class="px-4 py-2 text-left text-gray-600 dark:text-gray-300">Payment Frequency ID
                </th>
            </tr>
        </thead>
        <tbody>
            @foreach ($salaries as $salary)
                <tr class="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <td class="px-4 py-2 text-gray-800 dark:text-gray-300">{{ $salary->salary_grade }}
                    </td>
                    <td class="px-4 py-2 text-gray-800 dark:text-gray-300">{{ $salary->salary_amount }}
                    </td>
                    <td class="px-4 py-2 text-gray-800 dark:text-gray-300">
                        {{ $salary->payment_frequency_id }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
