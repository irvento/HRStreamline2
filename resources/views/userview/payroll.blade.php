                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-3 py-1 text-sm font-semibold rounded-full 
                                        @if ($payroll->payroll_status === 'Pending') bg-yellow-100 text-yellow-800 
                                        @elseif ($payroll->payroll_status === 'Completed') bg-green-100 text-green-800 
                                        @elseif ($payroll->payroll_status === 'Cancelled') bg-red-100 text-red-800 
                                        @endif">
