            ...
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                <form action="{{ route('performance.store') }}" method="POST">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="employee_id" id="employee_id" required size="5"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 shadow-sm overflow-y-auto max-h-48">
