    ...
    <div class="w-full mt-8">
        <div class="bg-gray-800 shadow-md rounded-lg p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('employee_info.create') }}"
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full border border-gray-700 rounded-lg shadow-sm">
                    <thead class="bg-gray-700">
                        <tr>
                            <th class="px-4 py-2 text-left text-gray-300 font-medium border-b border-gray-600">Employee
                                ID</th>
                            <th class="px-4 py-2 text-left text-gray-300 font-medium border-b border-gray-600">Employee
                            </th>
                            <th class="px-4 py-2 text-left text-gray-300 font-medium border-b border-gray-600">
                                Department</th>
                            ...
                            <th class="px-4 py-2 text-left text-gray-300 font-medium border-b border-gray-600">Actions
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($employeeInfos as $employeeInfo)
                            <tr class="hover:bg-gray-700">
                                <td class="px-4 py-2 border-b border-gray-600 text-gray-300">
                                    {{ $employeeInfo->employee ? $employeeInfo->employee->employee_id : 'No Employee' }}
                                </td>
                                <td class="px-4 py-2 border-b border-gray-600 text-gray-300">
                                    {{ $employeeInfo->employee ? $employeeInfo->employee->employee_fname : 'No Employee' }}
                                </td>
                                <td class="px-4 py-2 border-b border-gray-600 text-gray-300">
                                    {{ $employeeInfo->department ? $employeeInfo->department->department_name : 'No Department' }}
                                </td>
                                <td class="px-4 py-2 border-b border-gray-600 text-gray-300">
                                    {{ $employeeInfo->job ? $employeeInfo->job->job_title : 'No Job' }}
                                </td>
